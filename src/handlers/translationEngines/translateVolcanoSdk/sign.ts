...
const util = {
  crypto: {
    hmac: function hmac(key: WordArray | string, string: WordArray | string) {
      return hmacSHA256(string, key);
    },

    sha256: function sha256(data: string | WordArray) {
...
export const queryParamsToString = (params: Record<string, any>) =>
  Object.keys(params)
    .map((key) => {
...
export default class Signer {
  ...
  sortParams(params: Record<string, any>) {
